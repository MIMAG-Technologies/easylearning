...
function Payment() {
  const secretKey = import.meta.env.VITE_COPOUN_CODE;
      ...
      <form
        ...
        onSubmit={(e) => {
          ...
          if (cv === secretKey) {
            ...
            alert("Payment Gateway is not available yet");
          }
        }}
      >
        <div className="pay-payment--options">
        ...
        <div className="pay-separator">
          <hr className="pay-line" />
          <p>or pay using credit card</p>
          <hr className="pay-line" />
        </div>
        <div className="pay-course-details">
          <p>
            The fee for enrolling in the course titled{" "}
            <strong>"{course.title}"</strong> is{" "}
            <strong>RS {course.price.toLocaleString()}</strong>.
          </p>
        </div>

        <div className="pay-credit-card-info--form">
          <div className="pay-input_container">
            <label for="password_field" className="pay-input_label">
              Card holder full name
            </label>
            <input
              id="password_field"
              className="pay-input_field"
              type="text"
              name="input-name"
              title="Inpit title"
        ...
        <button className="pay-purchase--btn">Checkout</button>
      </form>
    </div>
  );
}
